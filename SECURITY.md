...
The [`starter-template@0.6.0` release contract](contracts/template-release-policy.json)
requires GitHub immutable releases before publishing the corresponding
[release](https://github.com/vireocodedev/starter-template/releases/tag/starter-template%400.6.0).
