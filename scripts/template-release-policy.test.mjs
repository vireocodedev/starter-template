...
const policy = {
  schemaVersion: 1,
  version: "0.8.3",
  tag: "starter-template@0.8.3",
  createVireoVersion: "0.8.3",
  ecosystemRelease: "npm-0.8.3_jvm-0.3.1",
  repository: "vireocodedev/vireo-template",
  releaseUrl:
    "https://github.com/vireocodedev/vireo-template/releases/tag/starter-template%400.8.3",
...
const validInputs = {
  ...
  compatibility: { schemaVersion: 1, id: "vireo-template-0.8.3" },
