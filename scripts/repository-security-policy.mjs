...
if (!pullRequest || pullRequest.dismiss_stale_reviews_on_push !== true || pullRequest.require_code_owner_review !== false || pullRequest.require_extra_approval_for_unattributed_changes !== false || pullRequest.require_last_push_approval !== false || pullRequest.required_approving_review_count !== 0 || pullRequest.required_review_thread_resolution !== true) problems.push("main ruleset must retain the interim single-maintainer pull-request controls without requiring an independent approval");
