...
[`starter-template@0.8.4` release contract](contracts/template-release-policy.json)
and its draft-and-publish
[GitHub release](https://github.com/vireocodedev/vireo-template/releases/tag/starter-template%400.8.4).
