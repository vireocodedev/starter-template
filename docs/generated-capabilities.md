...
The root `vireo` script pins the `vireo` executable from `create-vireo@0.8.2`.
The [`starter-template@0.8.2` release contract](https://github.com/vireocodedev/vireo-template/blob/starter-template%400.8.2/contracts/template-release-policy.json)
...
historical 0.8.0-to-0.8.1 and supported adjacent 0.8.1-to-0.8.2 project upgrades. When developing unpublished
