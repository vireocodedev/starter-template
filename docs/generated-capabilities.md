...
The root `vireo` script pins the `vireo` executable from `create-vireo@0.8.1`.
The [`starter-template@0.8.1` release contract](https://github.com/vireocodedev/vireo-template/blob/starter-template%400.8.1/contracts/template-release-policy.json)
...
supported adjacent 0.8.0-to-0.8.1 project upgrade. When developing unpublished
