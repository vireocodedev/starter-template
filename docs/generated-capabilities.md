...
The [`starter-template@0.7.0` release contract](https://github.com/vireocodedev/vireo-template/blob/starter-template%400.7.0/contracts/template-release-policy.json)
