...
The root `vireo` script pins the `vireo` executable from `create-vireo@0.8.7`.
The [`starter-template@0.8.7` release contract](https://github.com/vireocodedev/vireo-template/blob/starter-template%400.8.7/contracts/template-release-policy.json)
...
historical 0.8.3-to-0.8.4 and 0.8.4-to-0.8.6 transforms, and the supported
adjacent 0.8.6-to-0.8.7 project upgrade. The Template contract separately retains 0.8.4-to-0.8.5 solely
