...
tags and the immediately prior `starter-template@0.8.1` tag. It also contains
the exact no-bypass update-and-deletion payload for the prepared
`starter-template@0.8.2` tag in
`.github/rulesets/starter-template-0.8.2.json`. That checked-in payload is a
