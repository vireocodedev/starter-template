...
if (publishedTsconfig.includes("../../starter") || publishedTsconfig.includes("../starter/packages") || publishedTsconfig.includes("../../vireo") || publishedTsconfig.includes("../vireo/packages")) {
